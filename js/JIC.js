        ...
        compress: function(source_img_obj, quality, output_format){
             ...
             if(navigator.userAgent.search('iPhone')!==-1){
                ...
                if(source_img_obj.naturalWidth > source_img_obj.naturalHeight){
                    if(source_img_obj.naturalWidth > 2290){
                       
                        //Needs resizing
                        new_height = Math.floor((source_img_obj.naturalHeight*2290)/source_img_obj.naturalWidth);
                        new_width = 2290;
                    ...
                    if(source_img_obj.naturalHeight > 2290){
                        
                        //Needs resizing
                        new_width = Math.floor((source_img_obj.naturalWidth*2290)/source_img_obj.naturalHeight);
                        new_height = 2290;
